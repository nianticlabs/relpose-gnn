...
def K_from_frame(frame):
    ...
    return np.asarray([[intrisic[0], 0, intrisic[2]],
                       [0, intrisic[1], intrisic[3]],
...
class FrameSeqData:
    ...
    def append_frame(self, frame_idx, img_file_name, Tcw, camera_intrinsic, frame_dim,
                     time_stamp=0.0, depth_file_name=None, tag=None, rgb_intrinsic=None):
        """
        ...
        with open(json_file_path, 'r') as json_file:
            ...
            for frame in self.frames:
                ...
                if 'camera_intrinsic' in frame:
                    frame['camera_intrinsic'] = np.asarray(frame['camera_intrinsic'],
                                                           dtype=np.float32)
